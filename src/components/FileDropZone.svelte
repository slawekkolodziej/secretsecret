<script lang="ts">
    ...
    export let onFileInput: (fileList: FileList) => void;
...
>
    ...
    {#if isDragOver}
        <div
            class="fixed inset-0 bg-violet-500 bg-opacity-20 border-2 border-dashed border-violet-500 z-50 flex items-center justify-center"
        >
            <div class="bg-white p-6 rounded-lg shadow-lg">
                <div class="text-center">
                    <svg
                        class="mx-auto h-12 w-12 text-violet-500"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                    >
